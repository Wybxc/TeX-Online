...
sudo /usr/local/texlive/2022/bin/x86_64-linux/tlmgr install xetex ctex biber listings underscore ieeetran latexindent diagbox pict2e standalone tkz-graph
